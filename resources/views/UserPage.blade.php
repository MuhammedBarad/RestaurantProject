    ...
    <div class="container">
        <ul class="category">
            <form action="#menu" method="get">
                <li ><a href="/home" style="text-decoration: none;color: var(--clr-primary)">All</a></li>
                @foreach ($cats as $cat)

                    <li><input type="submit" style="border:none;background: none" name="category" value="{{$cat->cat_name}}"></li>
                @endforeach
            </form>
        ...
        <div class="container">
            <div class="restaurant-menu">
                ...
                <div class="menu-item">
                    <img src="{{$meal->image}}"
                        alt="" width="300px" height="300px" style="border-radius: 10px"/>
