...
@section('content')
    ...
    <form class="row g-3 container" action="{{ route('profile.update', $user->id) }}" method="POST" style="margin-left:10%"
        ...
        <div class="col-12">
            ...
            <input name="password" value="{{ Auth()->user()->password }}" type="password" class="form-control" id="inputAddress"
                placeholder="53xxxxxxxxx">
        </div>
        <div class="col-12">
            <label for="inputAddress" class="form-label">Phone</label>
            <input name="phone" value="{{ Auth()->user()->phone }}" type="text" class="form-control" id="inputAddress"
                placeholder="53xxxxxxxxx">
        </div>
        <div class="col-12">
            <label for="inputAddress" class="form-label">Address 1</label>
            <input value="{{ $user->address_one }}" name="address_one" type="text" class="form-control" id="inputAddress"
                placeholder="1234 Main St">
        </div>
        <div class="col-12">
            <label for="inputAddress2" class="form-label">Address 2</label>
            <input value="{{ $user->address_two }}" name="address_two" type="text" class="form-control"
